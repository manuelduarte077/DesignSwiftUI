...
//  DesignCodeSwiftUI
//
//  Created by Manuel Duarte on 26/6/22.
//
		...
		ZStack(alignment: .topTrailing) {
			ScrollView {
				...
				VStack(alignment: .leading, spacing: 30){
					...
					Text("Developing for iOS 14 requires a Mac with Catalina and Xcode 12. It isrecommended that you up grade to Big Sur in order to build for macOS using SwiftUI.You can still follow the iOS parts, which is the main focus of this course. However, some steps and code specific to the macOS app may not work.")
				}
				.padding()
